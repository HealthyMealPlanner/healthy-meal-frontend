        ...
        <div className="mt-6 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate/10">
          ...
          <div className="mt-3 grid grid-cols-4 gap-2 text-center">
            <div>
              ...
              <p className="text-[11px] text-slate">CAL</p>
            </div>
            <div>
              <p className="text-lg font-bold text-text-primary">
                {recipe.protein != null ? `${recipe.protein}g` : "–"}
              </p>
              <p className="text-[11px] text-slate">PROT</p>
            </div>
            <div>
              <p className="text-lg font-bold text-text-primary">
                {recipe.carbs != null ? `${recipe.carbs}g` : "–"}
              </p>
              <p className="text-[11px] text-slate">CARB</p>
            </div>
            <div>
              <p className="text-lg font-bold text-text-primary">
                {recipe.fat != null ? `${recipe.fat}g` : "–"}
              </p>
              <p className="text-[11px] text-slate">FAT</p>
            </div>
          </div>
        </div>
            ...
            {[1, 2, 3, 4, 5].map((value) => (
              ...
              >
                <Star
                  size={26}
                  className={
                    value <= rating ? "fill-orange text-orange" : "text-slate/25"
                  }
                />
              </button>
            ))}
